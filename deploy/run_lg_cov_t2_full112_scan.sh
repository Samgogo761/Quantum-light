#!/bin/bash
#=============================================================================
# LG-covariant full-112-band T2 scan for CrI3 classical-light runs.
#
...
#   4 lgcov_k40_b112_T2_0p5cycle    T2_cycles=0.5 (old solver deph_t2=0.5)
#   5 lgcov_k40_b112_T2_5p337fs     T2_fs=5.337  (same as 0.5 cycle at 3200 nm)
#   6 lgcov_k40_b112_T2_nodeph      T2_fs=1.0e30
#=============================================================================

#SBATCH --job-name=lgcov_t2
...
#SBATCH --output=lgcov_t2_%A_%a.out
#SBATCH --error=lgcov_t2_%A_%a.err
...
NK="${NK:-40}"
OUTROOT="${OUTROOT:-${WORKDIR}/output_lg_cov_t2_k${NK}_b112}"
DT_AU="${DT_AU:-0.35}"

CASES=(
  "lgcov_k${NK}_b112_T2_0p5fs 0.5 -1.0"
  "lgcov_k${NK}_b112_T2_1fs 1.0 -1.0"
  "lgcov_k${NK}_b112_T2_2fs 2.0 -1.0"
  "lgcov_k${NK}_b112_T2_5fs 5.0 -1.0"
  "lgcov_k${NK}_b112_T2_0p5cycle 10.0 0.5"
  "lgcov_k${NK}_b112_T2_5p337fs 5.337 -1.0"
  "lgcov_k${NK}_b112_T2_nodeph 1.0e30 -1.0"
)
...
read -r CASE_NAME T2_FS T2_CYCLES <<< "${CASES[${CASE_INDEX}]}"
OUTDIR="${OUTROOT}/${CASE_NAME}"

cd "${WORKDIR}" || { echo "ERROR: cannot cd to ${WORKDIR}"; exit 1; }

echo "============================================="
echo "  LG-covariant full-112 T2 scan"
echo "============================================="
echo "  Date:       $(date)"
echo "  Host:       $(hostname)"
...
compile_if_needed() {
  ...
  local lockdir="${WORKDIR}/.compile_lg_cov_t2.lockdir"
