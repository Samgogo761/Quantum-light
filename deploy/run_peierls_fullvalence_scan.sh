#!/bin/bash
#=============================================================================
# Peierls velocity-gauge full-valence classical-light scan for CrI3.
#
# Purpose: test whether keeping all 84 occupied valence bands and truncating
# only high conduction bands restores the low-order current cancellation.
#
# Recommended submission:
#   sbatch --array=0-4 deploy/run_peierls_fullvalence_scan.sh
#
# Cases:
#   0 vg_k10_nb94   nk=10  nb=1-94
#   1 vg_k10_nb104  nk=10  nb=1-104
#   2 vg_k10_nb112  nk=10  nb=1-112
#   3 vg_k20_nb94   nk=20  nb=1-94
#   4 vg_k20_nb104  nk=20  nb=1-104
#=============================================================================

#SBATCH --job-name=vg_fullval
...
#SBATCH --output=vg_fullval_%A_%a.out
#SBATCH --error=vg_fullval_%A_%a.err
...
OUTROOT="${OUTROOT:-${WORKDIR}/output_peierls_fullvalence_nodeph}"
T2_FS="${T2_FS:-1.0e30}"
DT_AU="${DT_AU:-0.35}"

CASES=(
  "vg_k10_nb94 10 1 94"
  "vg_k10_nb104 10 1 104"
  "vg_k10_nb112 10 1 112"
  "vg_k20_nb94 20 1 94"
  "vg_k20_nb104 20 1 104"
)
...
echo "============================================="
echo "  Peierls full-valence scan case"
echo "============================================="
echo "  Date:       $(date)"
echo "  Host:       $(hostname)"
...
compile_if_needed() {
  ...
  local lockdir="${WORKDIR}/.compile_peierls_fullval.lockdir"
